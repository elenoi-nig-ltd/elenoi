  ...
  return (
    <>
      <section className="page-hero page-hero--about wrap">
        ...
        <h1>Built to develop<br /><em>people and enterprise.</em></h1>
        <p>ELENOI Nig. Ltd brings diverse business interests together around a clear belief: capable people, principled leadership and useful enterprise can transform a nation.</p>
      </section>
      <section className="manifesto wrap">
        <p className="section-number">01 / Our foundation</p>
        <blockquote>“Excellence is not a destination. It is the discipline behind everything we choose to build.”</blockquote>
      </section>
      <section className="vision-mission">
        <div className="wrap vision-mission__grid">
          <article><span>Vision</span><h2>A model of organisational excellence.</h2><p>Setting a global pace in human capital and business leadership development and empowerment, while repositioning Nigeria as a major player in the global economy.</p></article>
