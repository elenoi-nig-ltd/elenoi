...
export const metadata: Metadata = { title: "Contact", description: "Start a conversation with ELENOI Nig. Ltd." };
    ...
    <section className="contact-page wrap">
      <div className="contact-page__intro">
        ...
        <div className="contact-details">
          <a href="mailto:hello@elenoi.com"><Mail size={17} /> hello@elenoi.com</a>
